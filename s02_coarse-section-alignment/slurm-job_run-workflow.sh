...
# <<< conda initialize <<<
mamba run -p "$root_dir/infrastructure/miniforge3/envs/nf" nextflow run "$root_dir/gfriedri-em-alignment-flows/s02_coarse-section_alignment/workflow.nf" --config $(pwd)/coarse-align.yaml -profile slurm -with-report -resume -disable-jobs-cancellation
