...
micromamba run -p "$root_dir/infrastructure/envs/nf" nextflow run "$root_dir/s02_coarse-section-alignment/workflow.nf" --config $(pwd)/coarse-align.yaml -profile slurm -with-report -resume -disable-jobs-cancellation
