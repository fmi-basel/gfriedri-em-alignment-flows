...
micromamba run -p "$root_dir/infrastructure/envs/nf" nextflow run "$root_dir/s01_tile-stitching/workflow.nf" --config $(pwd)/tile_stitching_config.yaml -profile slurm -with-report -resume -disable-jobs-cancellation
